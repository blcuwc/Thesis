#-----------------------
#environment : BranchLSTM
# usage : python depth_analysis.py ./onestep_classification/output/predictions.txt > ./onestep_classification/output/tables.txt
# usage : python depth_analysis.py ./twostep_classification/output/predictions.txt > ./twostep_classification/output/tables.txt
#----------------------
import os
import json
import numpy
