...
if __name__ == "__main__":
    ...
    fold_num = sys.argv[1]
    print "Fold %s depth analysis!" % str(fold_num)
    ...
    tweet_depth, test_predicted_label, test_label = load_test_depth_pred_true(train_dev_split, fold_num)
